...
namespace Dabl\Adapter\Propel\Platform;
...
use Dabl\Adapter\Propel\Model\Diff\PropelColumnDiff;
use Dabl\Adapter\Propel\Model\Diff\PropelDatabaseDiff;
use Dabl\Adapter\Propel\Model\Domain;
 ...
 */
class AccessPlatform extends DefaultPlatform
{
	...
	protected function initialize()
	{
		...
		$this->setSchemaDomainMapping(new Domain(PropelTypes::INTEGER_TIMESTAMP, "INT"));
